...
const myCreatedBucket = {
  bucketKey: 'e1dhsf2qwjhcuphmdvd9gmc2yig0rqlo-mo-bucket',
  bucketOwner: 'E1dhsF2qWjHCUPHMdVd9GMC2YiG0rqlO',
  createdDate: 1617260105316,
  permissions: [
    {
      authId: 'E1dhsF2qWjHCUPHMdVd9GMC2YiG0rqlO',
      access: 'full',
    },
  ],
  policyKey: 'transient',
...
const uploadedObj = {
  bucketKey: 'e1dhsf2qwjhcuphmdvd9gmc2yig0rqlo-mo-bucket',
  objectId:
    'urn:adsk.objects:os.object:e1dhsf2qwjhcuphmdvd9gmc2yig0rqlo-mo-bucket/Eilat_Shachmon_B4_Str_NNM_R21(ENG).rvt',
  objectKey: 'Eilat_Shachmon_B4_Str_NNM_R21(ENG).rvt',
  sha1: 'bca75055ab6e0524c351dc8825fa7b8bf20f80ac',
  size: 14213120,
  contentType: 'application/octet-stream',
  location:
    'https://developer.api.autodesk.com/oss/v2/buckets/e1dhsf2qwjhcuphmdvd9gmc2yig0rqlo-mo-bucket/objects/Eilat_Shachmon_B4_Str_NNM_R21(ENG).rvt',
};
